...
def custom_forward():
    origin_func_path = [
        'lmdeploy.vl.model.xcomposer2.Xcomposer2VisionModel._preprocess_4khd_7b',
    ]
    rewrite_func = [
        _forward_4khd_7b
    ]
...
class ImageGridDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        grid_image = grid_image.resize((self.img_w, self.img_h), Image.Resampling.LANCZOS)
...
def parse_args():
    ...
    parser.add_argument("--img-path", type=str, default="/data/ephemeral/home/sujin/ShareGPT4Video/captioner/videos_to_describe.json",
    ...
    parser.add_argument("--save-path", type=str, default="/data/ephemeral/home/sujin/ShareGPT4Video/captioner/captioner_output")
...
if __name__ == '__main__':
    ...
    for batch_data, filenames in dataloader:
        ...
        for filename, response in zip(filenames, final_responses):
            ...
            with open(os.path.join(args.save_path, filename+'fast_captioner.json'), 'w') as f:
